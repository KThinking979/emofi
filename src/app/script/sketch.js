...
//   if (res.shopSkills) {
//     for (let i = 0; i < res.shopSkills.length; i++) {
//       const skill = res.shopSkills[i];
...
//   if (res.bestGoal) {
//     bestGoal = parseInt(res.bestGoal);
//   }

//   if (res.bestGoalSwitch) {
//     bestGoalSwitch = parseInt(res.bestGoalSwitch);
//   }

//   if (res.sound) {
//     statusSound = res.sound;
//   }

//   if (res.coin) {
//     numberCoin = parseInt(res.coin);
//   }

//   if (res.face) {
//     face = res.face.id;
//     snake.setColorSnake(face);
//     snakeHome.setColorSnake(face);

//     _switch.setColorSnake(face);
//     _switchHome.setColorSnake(face);
//   }
